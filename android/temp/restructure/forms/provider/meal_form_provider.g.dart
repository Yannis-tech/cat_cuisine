...
String _$mealFormHash() => r'42c17f3863dc004bd7c674e0163749267fcdc7de';
...
abstract class _$MealForm
  ...
  late final InvalidType initialMeal;

  FutureOr<MealFormState> build(
    InvalidType initialMeal,
  );
}
...
class _MealFormProviderElement
  ...
  @override
  InvalidType get initialMeal => (origin as MealFormProvider).initialMeal;
}
